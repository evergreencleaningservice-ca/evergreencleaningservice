/**
 * The country list from the original quote form, verbatim — 250 entries in
 * the same order, with Canada pre-selected as the original has it.
 */
...
export const countries: Country[] = [
  ...
  { code: "SZ", name: "Eswatini (Kingdom of)" },
